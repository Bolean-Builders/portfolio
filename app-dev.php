...
<head>
    ...
    <title>boleanbuilders | app development</title>
    ...
    .hero-section {
      background-image: url('./assets/img/flutter.webp'); /* Replace with your actual image */
...
?>
        ...
        <div class="breadcrum-area breadcrumb-banner">
            <div class="container">
                <div class="section-heading heading-left" data-sal="slide-right" data-sal-duration="1000" data-sal-delay="300">
                    <h1 class="title h2">Transform Your Bussiness With Custom Mobile Apps</h1>
                    <p>Our experts app developers craft innovation, user friendly
                         solutions that drive engagement, boost productivity, and grow your revenue</p>
                </div>
  ...
  <section id="services" class="py-5">
    <div class="container text-center">
      ...
      <p class="text-muted mb-5">Our mobile app development services are designed to create high-performance, feature-rich apps that cater to the unique needs of your business.</p>

      <!-- App Development Service Cards -->
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">Android App Development</h5>
            <p class="service-description">
              We build custom Android apps tailored to your business needs. Whether you're looking to launch a consumer-facing mobile app or an enterprise solution, we use the latest technologies and tools to ensure your Android app delivers the best user experience and performance.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">iOS App Development</h5>
            <p class="service-description">
              Our iOS app development team creates apps that are sleek, efficient, and user-friendly. We design and develop iOS apps that work seamlessly across all Apple devices, from iPhones to iPads, providing your users with a premium experience.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">Hybrid App Development</h5>
            <p class="service-description">
              We specialize in hybrid app development, combining the best of both native and web apps. Our hybrid apps are built using technologies like React Native and Flutter, providing faster development times and broad platform support (iOS and Android) without compromising performance.
            </p>
          </div>
        </div>
      </div>
  ...
  <section class="py-5">
    <div class="container text-center">
      ...
      <p class="text-muted mb-5">Our team leverages the latest mobile development technologies to ensure your app is modern, scalable, and optimized.</p>
      <div class="row">
        <div class="col-md-3 mb-3">
          <img src="./assets/media/about/android.gif" alt="Android" class="img-fluid">
          <p>Android</p>
        </div>
        <div class="col-md-3 mb-3">
          <img src="./assets/media/about/ios.png" alt="iOS" class="img-fluid">
          <p>iOS</p>
        </div>
        <div class="col-md-3 mb-3">
          <img src="./assets/media/about/react.avif" alt="React Native" class="img-fluid">
          <p>React Native</p>
        </div>
        <div class="col-md-3 mb-3">
          <img src="./assets/media/about/flutter.webp" alt="Flutter" class="img-fluid">
          <p>Flutter</p>
        </div>
      </div>
    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="why-choose-us">
                            <div class="section-heading heading-left">
                                ...
                                <h3 class="title">Why Mobile App?</h3>
