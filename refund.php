...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/terms-of-use.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:47:01 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>boleanbuilders | Terms Of Use</title>
...
<body class="sticky-header">
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <div class="breadcrum-area">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <h1 class="title h2">Refund Policy</h1>
                </div>
            </div>
        ...
        <!--=====================================-->
        <section class="section-padding refund-policy-area">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="refund-policy-content">
                    <div class="section-title">
                        <h5 class="title">Effective Date: <span id="current-date"></span></h5>
                    </div>
                    
                    <h4>1. Our Refund Policy</h4>
                    <p>Bolean Builders provides custom software development services with client satisfaction as our top priority. Due to the nature of custom development work, we maintain the following refund policy to protect both our clients and our business.</p>
                    
                    <h4>2. Service Engagement Terms</h4>
                    <ul>
                        <li>All projects begin with a signed agreement or statement of work (SOW)</li>
                        <li>Payments are typically structured in milestones tied to deliverables</li>
                        <li>Refund eligibility depends on project phase and work completed</li>
                    </ul>
                    
                    <h4>3. Refund Eligibility</h4>
                    <p>Refunds may be available under these circumstances:</p>
                    <ul>
                        <li><strong>Initial Deposit:</strong> 100% refundable within 7 days if no work has commenced</li>
                        <li><strong>Milestone Payments:</strong> Partial refunds proportional to incomplete work if we fail to deliver agreed milestones</li>
                        <li><strong>Project Cancellation:</strong> Refund of unearned fees if cancelled by client mid-project</li>
                    </ul>
                    ...
                    <div class="non-refundable-notice">
                        ...
                        <ul>
                            ...
                            <li>Consulting hours already expended</li>
                            <li>Third-party costs (hosting, APIs, licenses, etc.)</li>
                            <li>Projects where requirements change mid-development</li>
                            <li>Services terminated by client after 50% completion</li>
                        </ul>
                    </div>
                    
                    <h4>5. How to Request a Refund</h4>
                    <ol>
                        <li>Submit a written request to accounting@yourcompany.com</li>
                        <li>Include project reference number and detailed justification</li>
                        <li>Our team will review within 10 business days</li>
                        <li>Approved refunds processed within 15 business days</li>
                    </ol>
                    
                    <h4>6. Dispute Resolution</h4>
                    <p>We prefer to resolve issues through additional development rather than refunds. Unresolved disputes may be submitted to mediation in [Your State/Country].</p>
                    
                    <h4>7. Special Cases</h4>
                    <ul>
                        <li><strong>Fixed-Price Projects:</strong> Subject to the terms in your specific contract</li>
                        <li><strong>Retainer Agreements:</strong> Unused retainer hours may be refunded if cancelled with 30 days notice</li>
                        <li><strong>Maintenance Contracts:</strong> Prorated refunds available for prepaid unused periods</li>
                    </ul>
                    ...
                    [Bolean Builders]<br>
                    Email: <a href="boleanbuilders@gmail.com">boleanbuilders@gmail.com</a><br>
                    Phone: [233543973755]</p>
                </div>
            </div>
        </div>
    </div>
