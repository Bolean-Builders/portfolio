...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:52 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
...
<body class="sticky-header">
    ...
    <header class="header axil-header header-style-1">
        ...
        <!--=           404 Area Start          =-->
        <!--=====================================-->
        <section class="coming-soon-area onepage-screen-area">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12">
                        <div class="site-logo">
                            <a href="index-1.html" class="logo-light"><img src="assets/media/logo-2.svg" alt="Logo"></a>
                            <a href="index-1.html" class="logo-dark"><img src="assets/media/logo-3.svg" alt="Logo"></a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-8">
                        <div class="content">
                            <h2 class="title">Our new website is on its way</h2>
                            <p>subscribe let notify you for our upcoming project</p>
                            <div class="countdown"></div>
                            <form action="" method="post">
                                <div class="input-group">
                                    <input type="email" class="form-control" placeholder="Email address">
                                    <button class="subscribe-btn" type="submit">Notify Me</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="thumbnail" data-sal="zoom-in" data-sal-duration="500" data-sal-delay="100">
                            <img src="assets/media/others/coming-soon.png" alt="Coming Soon">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:53 GMT -->
</html>