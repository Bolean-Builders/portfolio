...
<head>
    ...
    <title>boleanbuilders | Software Development</title>
    ...
    <style>
        .hero-section {
      background-image: url('https://via.placeholder.com/1920x600'); /* Update with actual background */
...
?>
        ...
        <div class="breadcrum-area breadcrumb-banner">
            <div class="container">
                <div class="section-heading heading-left" data-sal="slide-right" data-sal-duration="1000" data-sal-delay="300">
                    <h1 class="title h2">Stunning Software For Bussiness  And Organizations</h1>
                    <p>We create Software for Bussiness and organizations.</p>
                </div>
  ...
  <section id="services" class="py-5">
    <div class="container text-center">
      ...
      <p class="text-muted mb-5">We provide a wide range of custom software development services designed to enhance your business processes.</p>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">Custom ERP Solutions</h5>
            <p class="service-description">
              Our custom ERP solutions are designed to streamline and automate key business processes. We integrate various functionalities such as inventory management, HR, finance, and customer relations into a single unified system. This ensures your business can operate more efficiently and reduce manual workload. With custom ERP, we cater to the unique needs of your business to increase operational productivity and reduce costs.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">CRM Solutions</h5>
            <p class="service-description">
              Our CRM solutions help businesses improve customer relationships, streamline sales, and optimize marketing efforts. We design CRM systems that enable you to better manage customer data, track interactions, and analyze customer behavior. With a robust CRM, you can ensure a personalized customer experience that drives loyalty and growth.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">Data Analytics</h5>
            <p class="service-description">
              Make data-driven decisions with our advanced data analytics solutions. Our tools and platforms help businesses gather, analyze, and interpret data to derive actionable insights. Whether you need predictive analytics, real-time reporting, or detailed data visualization, we can develop custom data analytics solutions that support your decision-making and business strategy.
            </p>
          </div>
        </div>
      </div>
  ...
  <section class="contact-section">
    <h2>Ready to Start Your Software Project?</h2>
    <p>Contact us today and let’s discuss how our custom software solutions can help grow your business.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="why-choose-us">
                            <div class="section-heading heading-left">
                                ...
                                <p> We craft innovative web, app, and software solutions that empower businesses to thrive. With a focus on cutting-edge technology, creativity, and client success, we transform ideas into impactful digital experiences</p>
                            </div>
                            <div class="accordion" id="choose-accordion">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#choose-accordion">
                                        ...
                                        We start by understanding your vision, goals, and challenges. Through in-depth research and consultation, we define the project scope and create a roadmap for success.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#choose-accordion">
                                        <div class="accordion-body">
                                        Our team transforms ideas into tangible designs and prototypes. We focus on user experience, functionality, and aesthetics to ensure the solution aligns with your brand and goals
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#choose-accordion">
                                        <div class="accordion-body">
                                        We build robust and scalable solutions. Rigorous testing ensures the final product is bug-free, secure, and performs flawlessly.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-6 offset-xl-1">
                        <div class="contact-form-box shadow-box mb--30">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="axil-btn btn-fill-primary btn-fluid" name="submit-btn">Get Request Now</button>
                                </div>
                            </form>
                        </div>
                    </div>
