...
<head>
    ...
    <title> boleanbuilders| Training</title>
...
<body class="sticky-header">
        ...
        <div class="breadcrum-area breadcrumb-banner">
            <div class="container">
                <div class="section-heading heading-left" data-sal="slide-right" data-sal-duration="1000" data-sal-delay="300">
                    <h1 class="title h2">Training</h1>
                    <p>Our training programs is design for individuals 
                        who want to enter into tech or already in but want to upgrade himself</p>
                </div>
  ...
  <section class="hero-section">
    <div class="hero-content container">
      <h1>Professional Training Services</h1>
      <p>Empowering individuals and organizations with essential skills for the digital age.</p>
      <a href="#enroll" class="btn btn-primary btn-lg mt-3">Enroll Now</a>
    </div>
  </section>
  ...
  <section id="services" class="py-5">
    <div class="container text-center">
      ...
      <p class="text-muted mb-5">Our training programs are designed to help you excel in the tech industry.</p>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <p class="service-description">
              Master the art of web development with our comprehensive training. Learn HTML, CSS, JavaScript, and frameworks like React and Angular to create modern, responsive websites.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <p class="service-description">
              Learn how to develop feature-rich mobile apps for Android and iOS. Our training includes programming languages like Swift, Kotlin, and frameworks like Flutter and React Native.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">Programming Languages</h5>
            <p class="service-description">
              Gain expertise in programming languages like Python, Java, C++, and more. Our training is designed to help you become proficient in coding and problem-solving.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <p class="service-description">
              Learn how to protect systems and data from cyber threats. Our training covers ethical hacking, network security, and more to prepare you for a career in cybersecurity.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="service-card">
            ...
            <h5 class="service-title">Computer Networking</h5>
            <p class="service-description">
              Understand the fundamentals of computer networking. Our training covers network configuration, troubleshooting, and advanced networking concepts.
            </p>
          </div>
        </div>
      </div>
