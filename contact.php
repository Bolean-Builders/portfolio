...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:58 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("message submitted succesfully.");</script>';
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 offset-xl-1">
                        <div class="contact-info mb--100 mb_md--30 mt_md--0 mt--150">
                            ...
                            <h4 class="phone-number"><a href="tel:233543973755">233543973755</a></h4>
                        </div>
                        <div class="contact-info mb--30">
                            <h4 class="title">Email</h4>
                            <p>Our support team will get back to in 48-h during standard business hours.</p>
                            <h4 class="phone-number"><a href="boleanbuilders@gmail.com">boleanbuilders@gmail.com</a></h4>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <div class="footer-menu-link">
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a href="service-development.php">Software Development</a></li>
                                               
                                
                                                <li><a href="service-development.php">Digital Marketing</a></li>
                                                <li><a href="service-development.php">Training</a></li>
                                            </ul>
                        ...
                        <div class="col-md-6">
                            <div class="footer-bottom-link">
                                <ul class="list-unstyled">
                                    <li><a href="privacy-policy.php">Privacy Policy</a></li>
                                    <li><a href="terms-of-use.php">Terms of Use</a></li>
                                    <li><a href="terms-of-use.php">Refund Policy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
