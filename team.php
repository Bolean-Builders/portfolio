...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:46 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>boleanbuilders | Team</title>
                ...
                <div class="row">
                        ...
                        <div class="team-grid active">
                            <div class="thumbnail">
                                <a href="single-team.html">
                                    <img src="assets/media/team/net.jpg" alt="Team Member">
                                </a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a href="index.php">Kyere Emmanuel</a></h4>
                                <span class="designation">Team Owner</span>
                                <span class="designation">Software Enginerr</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="team-grid">
                            <div class="thumbnail">
                                <a href="index.php">
                                    <img src="assets/media/team/ap.jpg" alt="Team Member">
                                </a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a href="index.php">Precious Adedokun OluwaDamilare</a></h4>
                                <span class="designation">Team Member</span>
                                <span class="designation">Full Stack PhP Developer</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="team-grid">
                            <div class="thumbnail">
                                <a href="index.php">
                                    <img src="assets/media/team/h-web.jpg" alt="Team Member">
                                </a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a href="index.php">IMRAN Quareebulahi Hawwal</a></h4>
                                <span class="designation"> Team Member</span>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="team-grid">
                            <div class="thumbnail">
                                <a href="single-team.html">
                                    <img src="assets/media/team/hes.jpg" alt="Team Member">
                                </a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a href="index.php">Hesborn Nyang'ara</a></h4>
                                <span class="designation"> Team Member</span>
                                <span class="designation">Full Stack Developer</span>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="team-grid">
                            ...
                            <div class="content">
                                <h4 class="title"><a href="index.php">Charles Romeo</a></h4>
                                <span class="designation">Team member</span>
                                <span class="designation"> Frontend Enginerr</span>
                            </div>
                        </div>
                    </div>
                    <!-- #region 
