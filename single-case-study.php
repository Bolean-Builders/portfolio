...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/single-case-study.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:45 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>boleanbuilders | Case Study Details</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="banner-thumbnail" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="400">
                            <img class="paralax-image" src="assets/media/others/case-study-1.png" alt="Illustration">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="counterup-progress counterup-style-2">
                            <div class="icon">
                                <img src="assets/media/icon/icon-10.png" alt="Apple">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 mt--90 mt_md--0" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="counterup-progress counterup-style-2">
                            <div class="icon">
                                <img src="assets/media/icon/icon-11.png" alt="Apple">
                            </div>
                            <div class="count-number h2">
                    ...
                    <div class="col-lg-3 col-sm-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="counterup-progress counterup-style-2">
                            <div class="icon">
                                <img src="assets/media/icon/icon-12.png" alt="Apple">
                            </div>
                            <div class="count-number h2">
                    ...
                    <div class="col-lg-3 col-sm-6 mt--90 mt_md--0" data-sal="slide-up" data-sal-duration="800" data-sal-delay="400">
                        <div class="counterup-progress counterup-style-2">
                            <div class="icon">
                                <img src="assets/media/icon/apple-black.png" alt="Apple">
                            </div>
                            <div class="count-number h2">
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <div class="footer-menu-link">
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a href="wed-development.php">Website Development</a></li>
...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/single-case-study.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:46 GMT -->
</html>