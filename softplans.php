...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:15 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>boleanbuilders | Software Plans</title>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO enquiry (name, email, message) VALUES ('$name','$email','$mesage')";
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="banner-content">
                            <span class="subtitle" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="100"></span>
                            <h1 class="title" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="200">Software Development Plans</h1>
                            <div class="btn-group" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="300">
                                ...
                                <a href="about-us.php" class="about-btn">About Us</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="pricing-table active pricing-borderd">
                            <div class="pricing-header">
                                ...
                                <span class="subtitle">A beautiful, simple Software</span>
                        ...
                        <div class="pricing-table pricing-borderd">
                            ...
                            <div class="pricing-body">
                                <ul class="list-unstyled">
                                    ...
                                    <li> Cross-Platform Developmen</l i>
...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 15:46:20 GMT -->
</html>